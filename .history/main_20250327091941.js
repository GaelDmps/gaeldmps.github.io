...
const escalade = [
  {
    image1: "./img/escalade/escalade-moi.JPG",
    image2: "./img/escalade/salle-haut.jpg",
    image3: "./img/escalade/salle-vide.jpg",
    image4: "./img/escalade/suspendu.jpg",
    image5: "./img/escalade/suspendu-2.jpg",
    titre: "Ma passion sport : l'escalade.jpg",
...
function showescalade() {
  ...
  for(const element of escalade){
    ...
    articleesc.classList.add('escposition')
    ...
    articleesc.appendChild(esctitre)
  }
