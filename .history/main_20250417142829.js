...
const escalade = [
  {
    ...
    commentaire1: "L'escalade est pour moi bien plus qu'un sport. La salle d'escalade est un endroit ou je peux me surpasser et grimper toujours plus haut et augmenter la difficulté quand je me sens prêt a passer au palier suivant.",
    commentaire2: "C'est aussi un un sport qui se pratique en duo, donc communiquer, avoir confiance en la personne avec qui je grimpe est primordial pour éviter les accidents.",
    commentaire3: "En pratiquant j'ai donc appris a communiquer et travailler en équipe qui sont aujourd'hui des compétences très utiles dans le monde du travail.",
...
function showsetup() {
  ...
  for(const element of setup){
    ...
    group.appendChild(setupcommentair2)
  }
